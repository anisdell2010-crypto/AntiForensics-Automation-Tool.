...
* **IBM:** Cybersecurity Fundamentals.https://www.credly.com/badges/e80a886c-352e-4c89-9374-f1c222fab989/public_url
 ...
 ⚠️Disclaimer
​This project is part of my journey as an ISC (Information Security) Candidate. It was developed to demonstrate automation in anti-forensics and system hardening. Use it responsibly and only on systems you own or have permission to test.
...
#If you don't see the preview image, here is exactly what the terminal will display during execution:
​Case 1: If VPN is NOT active (Security Isolation)
[!] WARNING: VPN is NOT active! Isolating targets...

[!!!] Starting Professional Full Wipe Operation...
[+] Shredding sensitive files...
[+] Resetting identity for wlan0...
[+] Resetting identity for wlan1...
[+] Performing Swap Wiping...
[+] Cleaning system logs...
[+] Flushing RAM caches...
[+] Purging command history...

[✔] Wipe Successful: Files, Logs, RAM, and Swap are cleared.

Case 2: If VPN is active (Routine Cleanup)
[✔] VPN is active. Starting routine cleanup...
